...
public class BruteForceETSP extends Basic
{
...
//==================================================================================================
  ...
  public static void main(String[] args)
  {
    BruteForceETSP bf;
    if( args.length == 1 )
      bf = new BruteForceETSP("Brute Force TSP", 0, 0, pixelWidth, pixelHeight, args[0] );
    else
      bf = new BruteForceETSP("Brute Force TSP", 0, 0, pixelWidth, pixelHeight, "" );
  }
  ...
  public BruteForceETSP( String title, int ulx, int uly, int pw, int ph, String fileName )
  {
